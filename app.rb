  ...
  <body>
    ...
    <div id='container'>
      ...
      <div id='main'>
        ...
        <div class='staff'>
          <img src='/founder.jpg' alt='founder' class='small-thumb' />
          <p class='employee'>KAMLESH | Founder</p>
          <p class='bio'>Kamlesh Kumar Rangi was drinking kombucha out of his favorite Hans
